var checkWhichPage = function() {
  ...
  if (addr.length != 0) {
    $('#horizontalBar li a').each(function() {
...
var activeSearch = function() {
  $('#horizontalBar #inputWrapper input').on('input', function() {
    $('#horizontalBar li').css({'border-top': '1px solid #6c6a65', 'border-bottom': '0' });
    $('#horizontalBar li:last-child').css('border-bottom', '1px solid #6c6a65');
    ...
    $('#horizontalBar li:visible:last').css('border-bottom', '1px solid #6c6a65');
  });
};
