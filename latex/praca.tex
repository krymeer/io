...
% Usunięcie kropek na końcu pozycji w bibliografii
\newcommand\EatDot[1]{}
	...
	\begin{titlingpage}
		...
		\begin{center}
			\begin{picture}(300,510)
				...
				\put(10,500){\makebox(0,0)[l]{\large \textsc{Politechnika Wrocławska}}}
% Tytuł pracy
				\put(10,380){\Huge \textsc{Zastosowanie technologii}}
				\put(10,340){\Huge \textsc{CSS Grids do budowy}}
				\put(10,300){\Huge \textsc{nowoczesnych stron WWW}}
% Autor pracy
				\put(10,260){\makebox(0,0)[l]{\large \textsc{Krzysztof Radosław Osada}}}
				\put(10,240){\makebox(0,0)[l]{\large Numer indeksu: 221440}}
% Dane promotora
				\put(220,160){\makebox(0,0)[l]{\large Praca inżynierska napisana}}
				\put(220,140){\makebox(0,0)[l]{\large pod kierunkiem prof. dr. hab.}}
				\put(220,120){\makebox(0,0)[l]{\large \textsc{Jacka Cichonia}}}
			
				\put(115,-60){\includegraphics[width=0.15\textwidth]{pwr}}
	...
	\nocite{*} % Wyświetlanie wszystkich pozycji
