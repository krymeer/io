    ...
    _createClass(InputWrapper, [{
        ...
        value: function handleChange(event) {
            ...
            if (!this.props.disabled) {
                ...
                var inputValid = this.props.optional ? true : typeof this.props.expectedValue !== 'undefined' ? this.props.type === 'multi-text' || this.props.type === 'text-select-text' ? this.props.expectedValue.join(this.props.separator) === inputValue.join(this.props.separator) : this.props.ignoreCaseAndLines ? this.props.expectedValue.toLowerCase().replace(/\n/g, ' ') === inputValue.toLowerCase() : this.props.expectedValue === inputValue : typeof this.props.regex !== 'undefined' ? this.props.regex.test(inputValue) : typeof this.props.regexp !== 'undefined' ? new (Function.prototype.bind.apply(RegExp, [null].concat(_toConsumableArray(this.props.regexp))))().test(inputValue) : inputValue !== '';
