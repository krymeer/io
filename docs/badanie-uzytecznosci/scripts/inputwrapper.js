...
var InputWrapper = function (_React$Component) {
    ...
    function InputWrapper(props) {
        ...
        if (_this.props.type === 'mask' || _this.props.type === 'textarea' || _this.props.type === 'text-arrows' || _this.props.type === 'text' || _this.props.type === 'select-filtered' || _this.props.type === 'select' && _this.props.otherOption || _this.props.type === 'autocomplete') {
    ...
    _createClass(InputWrapper, [{
        ...
        value: function handleChange(event) {
            ...
            if (!this.props.disabled) {
                ...
                var inputValid = this.props.optional ? true : typeof this.props.expectedValue !== 'undefined' ? this.props.type === 'multi-text' || this.props.type === 'text-select-text' ? this.props.expectedValue.join(this.props.separator) === inputValue.join(this.props.separator) : this.props.ignoreCaseAndLines ? this.props.expectedValue.toLocaleLowerCase().replace(/\n/g, ' ') === inputValue.toLocaleLowerCase() : this.props.ignoreAllButLetters ? this.props.expectedValue.toLocaleLowerCase().replace(/\n+/g, ' ').replace(/[:;,.]+/g, '') === inputValue.toLocaleLowerCase() : this.props.expectedValue === inputValue : typeof this.props.regex !== 'undefined' ? this.props.regex.test(inputValue) : typeof this.props.regexp !== 'undefined' ? new (Function.prototype.bind.apply(RegExp, [null].concat(_toConsumableArray(this.props.regexp))))().test(inputValue) : inputValue !== '';
            ...
            return React.createElement(
                ...
                this.props.type === "autocomplete" && this.state.suggestion && this.state.suggestion.commonSubstr && this.state.suggestion.complement ? React.createElement(
                    ...
                    React.createElement(
                        'span',
                        null,
                        this.state.suggestion.complement
                    )
                ) : null,
                ...
                this.props.speechRecognition && React.createElement(
                    'div',
                    { className: ("sr-wrapper " + (this.props.disabled ? "disabled" : "") + " " + (this.props.speechRecognition.currentIndex === this.props.index ? "active" : "") + " " + this.props.type).trim().replace(/\s+/g, " ") },
                    React.createElement(
                        'i',
